...
void AnimationSetPatcher::CreateAnimation(const char* StateName = "Anim", const char* FileName = "sn_anim", float PlaybackSpeed = 1.0f, bool Loop = false, const char* DestinationState = nullptr) {
    m_newAnimationData.emplace_back(StateName, FileName, PlaybackSpeed, Loop, DestinationState);
}

void AnimationSetPatcher::CreateAnimationSuper(const char* StateName = "AnimSp", const char* FileName = "ssn_anim", float PlaybackSpeed = 1.0f, bool Loop = false, const char* DestinationState = nullptr) {
    m_newAnimationDataSuper.emplace_back(StateName, FileName, PlaybackSpeed, Loop, DestinationState);
}
