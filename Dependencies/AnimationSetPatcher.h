...
public:
    ...
    static void CreateAnimation(const char* StateName, const char* FileName, float PlaybackSpeed, bool Loop, const char* DestinationState);
    static void CreateAnimationSuper(const char* StateName, const char* FileName, float PlaybackSpeed, bool Loop, const char* DestinationState);
};
