...
const char* volatile const AnimationSetPatcher::IdleKoco = "IdleKoco";
const char* volatile const AnimationSetPatcher::AirDodgeL = "AirDodgeL";
const char* volatile const AnimationSetPatcher::AirDodgeR = "AirDodgeR";
void AnimationSetPatcher::applyPatches()
{
    m_newAnimationData.emplace_back(IdleKoco, "sn_lcslr_emote01", 1.0f, false, nullptr);
    m_newAnimationData.emplace_back(AirDodgeL, "sn_avoid_l", 1.0f, false, nullptr);
    m_newAnimationData.emplace_back(AirDodgeR, "sn_avoid_r", 1.0f, false, nullptr);
